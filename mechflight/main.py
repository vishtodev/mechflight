...
mycon=db.connect(host='localhost',user='root',password='123456789')
c=mycon.cursor()
try:
...
def signup_check():
    ...
    if uname_entry.get()=="" or password_entry.get()=="" or cpassword_entry.get()=="" or email_entry.get()=="":
        ...
        mycon=db.connect(host='localhost',user='root',password='123456789',database='mechflight')
        c=mycon.cursor()
...
def game():
    ...
    def highscore():
        mycon1=db.connect(host='localhost',user='root',password='123456789',database='mechflight')
        c=mycon1.cursor()
